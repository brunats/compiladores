...
CmdSe:		TIF TAPAR ExprLogica TFPAR Bloco{corrigir($3.listaV,$5.label);corrigir($3.listaF,novoLabel());}
...
CmdEscrita:	TPRINT TGETSTATIC TAPAR ExprAritmetica TFPAR TPVIRG{adicionarInstrucao(IINVOKE, -1);}
