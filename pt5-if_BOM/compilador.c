...
int main(){
	...
	strcpy(cuzinho,"pica10");
	insere(&cu,cuzinho);
	strcpy(cuzinho,"pica2");
	insere(&cu,cuzinho);
	strcpy(cuzinho,"pica3");
	insere(&cu,cuzinho);
	strcpy(cuzinho,"pica9");
	insere(&cu,cuzinho);
	strcpy(cuzinho,"pica5");
	insere(&cu,cuzinho);
	strcpy(cuzinho,"pica6");
	insere(&cu,cuzinho);
	strcpy(cuzinho,"pica8");
	insere(&cu,cuzinho);
	imprime(cu);
    strcpy(a->nomeId,"Mas�aaaa");
    a->tipo = STRING;
